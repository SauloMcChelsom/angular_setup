...
@NgModule({
	imports: [CommonModule, ReactiveFormsModule, AngularMaterialModule, DialogSignOutRoute],
	declarations: [DialogSignOut, DialogSignOutRef],
	exports: [DialogSignOut, DialogSignOutRef],
	providers: [],
})
