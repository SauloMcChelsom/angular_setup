...
export class StateService<T> {
   ...
   * this.state$.asObservable() garante que o select método retorne um Observable (e não um AnonymousSubject).
   */
   ...
   * Dentro do state$.next método, o estado parcial é mesclado com o objeto de estado completo. Finalmente, 
